...
public partial class AdventureWorksDw2022Context : DbContext
{
    ...
    public virtual DbSet<FactInternetSalesC> FactInternetSalesCs { get; set; }

    public virtual DbSet<FactInternetSalesHeap> FactInternetSalesHeaps { get; set; }

    public virtual DbSet<FactInternetSalesR> FactInternetSalesRs { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=ConnectionStrings:TestConnection");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<FactInternetSalesC>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("FactInternetSales_CS");
        ...
        modelBuilder.Entity<FactInternetSalesHeap>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("FactInternetSales_Heap");
        ...
        modelBuilder.Entity<FactInternetSalesR>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("FactInternetSales_RS");

            entity.HasIndex(e => new { e.SalesOrderNumber, e.SalesOrderLineNumber }, "idx_FactInternetSalesRS_PK").IsClustered();
